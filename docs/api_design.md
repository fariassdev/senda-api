...
4.  **Generate course images**: Implement a image generation service to set representative course images following the Senda style, guidelines and philosophy.
5.  **Basic CMS UI:** Implement a foundational user interface for the CMS to facilitate interaction with the API's functionalities.
